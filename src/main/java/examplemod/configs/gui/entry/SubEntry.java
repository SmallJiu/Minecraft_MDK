...
import examplemod.configs.gui.GuiConfig;
...
public class SubEntry extends ConfigEntry<Object> {
    ...
    public SubEntry(String name, ForgeConfigSpec spec, Config config, String path, GuiConfig parent) {
        ...
        this.button = this.addWidget(new GuiConfig.GuiButton(0, 0, 300, 20, Component.nullToEmpty(name), btn-> parent.getMinecraft().setScreen(gui), Supplier::get));
